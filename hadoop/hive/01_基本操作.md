...
-- 设置查询计划显示级别
[master2:21000] > set explain_level=0,1,2,3;
-- impala查看表/列统计信息
[master2:21000] > show table/column stats table_name;
-- impala计算表统计信息：会预先分析table和column的结构,将几个常用的count值统计好并存储在元数据中,impala执行查询时会根据存储的元数据做相应查询优化,在关联查询中速度提升很多
[master2:21000] > compute stats table_name;  -- 全量
[master2:21000] > compute incremental stats table_name partition(dt='20200612');  -- 增量
